...
/opt/apache-mahout-distribution-0.11.0/bin/mahout split -i files-vectors/tfidf-vectors --trainingOutput files-train-vectors --testOutput files-test-vectors --randomSelectionPct 40 --overwrite --sequenceFiles -xm sequential
